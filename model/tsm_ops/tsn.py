...
# from https://github.com/mit-han-lab/temporal-shift-module/blob/master/ops/models.py

from torch import nn

from model.tsm_ops.basic_ops import ConsensusModule
from model.tsm_ops.transforms import *
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model:
            ...
            if self.is_shift:
                ...
                from model.tsm_ops.temporal_shift import make_temporal_shift
                make_temporal_shift(self.base_model, self.num_segments,
                                    n_div=self.shift_div, place=self.shift_place, temporal_pool=self.temporal_pool)

            if self.non_local:
                print('Adding non-local module...')
                from model.tsm_ops.non_local import make_non_local
            ...
            self.base_model.avgpool = nn.AdaptiveAvgPool2d(1)
            if self.is_shift:
                from model.tsm_ops.temporal_shift import TemporalShift
